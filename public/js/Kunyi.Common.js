...
eval(function(p, a, c, k, e, d) {
    ...
    $.fn.extend({
        ChangeUrl: function(options) {
            ...
            element = options.loadPage != "" ? element.load(options.loadPage,
...
Kunyi = {
    ...
    Msg: {
        ...
        MsgTips: function(timeOut, msg, speed, type) {
            ...
            timeOut);
            //鼠标移到提示层时清除定时器
            $tip_container.on("mouseover",
            function() {
                clearTimeout(window.timer);
            });
            //鼠标移出提示层时启动定时器
            $tip_container.on("mouseout",
            function() {
                window.timer = setTimeout(function() {
                    $tip_container.slideUp(speed);
                    $(".tip_container").remove();
    ...
    InitFun: function() {
        $("div#Loading").fadeOut(1288, "easeOutQuart",
        function() {
            $(this).remove();
        });
        window.setTimeout(function() {
            $("header .toolBase").animate({
                top: "0px"
            },
            1188, "easeOutQuint");
        },
    ...
    QuickMenuBase: $("nav .quickMenuBase"),
    BaseMark: $(".BaseMark").eq(0),
    Index: {}
};
$(function() {
    ...
    $("#BtnQRMore").click(function() {
        ...
        1288, "easeInOutQuart");
        $obj.stop(false, true).delay(288).animate({
            opacity: 1
        },
        588, "easeInQuart");
    });
        ...
        function() {
            ...
            if ($("#ddlDepartment").length > 0) {
                $("#ddlDepartment").change(function(e) {
                    ...
                    } else $ddlOffices.html("<option value=\"0\">选择科室</option>");
                });
            }
        });
    },
